...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="labelName" style="padding-left: 400px;">
        <asp:Label ID="Label5" runat="server" Text="Нагрузка сотрудников"></asp:Label>
    </div>
    <div style="padding-top: 10px">
        <div class="dropDownList">
            <asp:Label ID="Label7" runat="server" Text="ФИО учителя:" Font-Size="18"></asp:Label>
            <asp:DropDownList ID="DropDownList15" runat="server" DataSourceID="SqlDataSource3" DataTextField="Name_employee" DataValueField="Code_employee" AutoPostBack="True" AppendDataBoundItems="True">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolWorkConnectionString1 %>"
        DeleteCommand="DELETE FROM [Load_employee] WHERE [Code_list] = @Code_list"
        InsertCommand="INSERT INTO [Load_employee] ([Code_lesson], [Code_employee]) VALUES (@Code_lesson, @Code_employee)"
        SelectCommand="IF @CodeEmployee=0 SELECT * FROM [Load_employee] ELSE SELECT * FROM [Load_employee] WHERE Code_employee=@CodeEmployee"
        UpdateCommand="UPDATE [Load_employee] SET [Code_lesson] = @Code_lesson, [Code_employee] = @Code_employee WHERE [Code_list] = @Code_list">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList15" Name="CodeEmployee" />
        </SelectParameters>
        <DeleteParameters>
